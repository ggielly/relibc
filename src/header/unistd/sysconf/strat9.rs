/// Strat9-OS sysconf implementation.
/// Constants borrowed from Linux/Musl but adapted for Strat9-OS.
use core::{
    ffi::{c_int, c_long},
    mem::size_of,
};
...
pub(super) fn sysconf_impl(name: c_int) -> c_long {
    ...
    match name {
        _SC_CLK_TCK => 100,
        _SC_CHILD_MAX => 1024,  // Reasonable default for Strat9-OS
        _SC_NGROUPS_MAX => NGROUPS_MAX as c_long,
        _SC_OPEN_MAX => 256,    // Reasonable default for Strat9-OS
        _SC_STREAM_MAX => -1,
        _SC_TZNAME_MAX => -1,
        _SC_JOB_CONTROL => 1,
        _SC_SAVED_IDS => 1,
        ...
        _SC_PHYS_PAGES => -1,       // To be implemented by Strat9-OS
        _SC_AVPHYS_PAGES => -1,     // To be implemented by Strat9-OS
        _SC_ATEXIT_MAX => -1,
        _SC_PASS_MAX => -1,
